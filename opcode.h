...
namespace asmb
{
    ...
    namespace masque
    {
        ...
        inline constexpr opcode::instruction_t RD { 0b0000'0011'1000'0000 };
        inline constexpr opcode::instruction_t RT { 0b0000'0000'0111'0000 };
        inline constexpr opcode::instruction_t RS { 0b0000'0000'0000'1110 };

        // le masque de l'opcode
        inline constexpr opcode::instruction_t OPCODE { 0b1111'1100'0000'0000 };

        // le dernier bit designe une erreur
        inline constexpr opcode::instruction_t ERREUR { 1 };
    }
}
